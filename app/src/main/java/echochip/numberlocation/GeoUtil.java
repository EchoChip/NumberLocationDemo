...
public class GeoUtil {
    ...
    public static String getGeocodedLocationFor(Context context, String phoneNumber) {
        ...
        Log.i(TAG, "structuredNumber: " + structuredNumber);
        Log.i(TAG, "locale: " + locale);
        return geocoder.getDescriptionForValidNumber(structuredNumber, locale);
    }
    ...
    public static Phonenumber.PhoneNumber getStructedNumber(Context context, String phoneNumber) {
        try {
            final Phonenumber.PhoneNumber structuredNumber = mPhoneNumberUtil.parse(phoneNumber, getCurrentCountryIso(context));
